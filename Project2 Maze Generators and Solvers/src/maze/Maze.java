 ...
 *         map[r][c].c == c, all neighbor cell objects are assigned correctly
...
public abstract class Maze {
	...
	// e.g., the northeast neighbor of map[r][c] would be map[r +
	 ...
	 * @return true if the cell is on any of the four sides of the maze. Otherwise
	 *         false.
	 */
	 ...
	 * @param tunnelList A list tunnels, each in the form of {p1Row, p1Col,
	 *                   p2Row,p2Col}.
	 */
	 ...
	 * 
	 * @return true if it is perfect maze, i.e. every cell can be visited and there
	 *         is no loop.
	 */
